...
class AdminUser(models.Model):
    ...
    role = models.CharField(max_length=191, choices=AdminRole.choices, default=AdminRole.SUPER_ADMIN)
    service = models.ForeignKey(Service, on_delete=models.DO_NOTHING, db_column="serviceId", blank=True, null=True)
    created_at = models.DateTimeField(db_column="createdAt", auto_now_add=True)
    updated_at = models.DateTimeField(db_column="updatedAt", auto_now=True)
