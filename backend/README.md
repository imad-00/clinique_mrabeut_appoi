...
3. Run the API:
   ...
   # Optional: create/update a service-scoped admin
   python manage.py seed_service_admin --email service-admin@example.com --password change-me --service-id <SERVICE_ID>
